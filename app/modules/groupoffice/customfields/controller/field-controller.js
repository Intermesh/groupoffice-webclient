...
/* Controllers */
angular.module('GO.Modules.GroupOffice.CustomFields').controller('GO.Modules.GroupOffice.CustomFields.FieldController', [
	'$scope',
	...
	function ($scope, Model, $state, close, readPromise, config, fieldModel) {
