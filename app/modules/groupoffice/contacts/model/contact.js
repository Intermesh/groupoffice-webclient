...
angular.module('GO.Modules.GroupOffice.Contacts').factory('GO.Modules.GroupOffice.Contacts.Model.Contact', [
	...
	function (Model, ServerAPI) {
		...
		Contact.prototype.$returnProperties = "*,photoBlob,emailAddresses,phoneNumbers,dates,addresses[*,formatted],tags[id,name,color],customfields,organizations[id,name],employees[id, name, photoBlobId],urls,groups";
