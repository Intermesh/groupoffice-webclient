...
angular.module('GO.Core').service('GO.Core.Services.Application', [
	...
	function(CurrentUser){
		 ...
		 * @param {type} deprecatedClientModelName The client tmodel name eg. 'GO.Modules.GroupOffice.Imap.Model.Account' Used to load the account data from the server
		 ...
		 * @returns {undefined}
		 */
		App.prototype.addAccountType = function(serverModelName, deprecatedClientModelName, iconCls, editDialogConfig, createDialogConfig) {			
			this.accountTypes[serverModelName] = {
				...
				iconCls: iconCls,
				clientModelName: deprecatedClientModelName,
